...
fn install_from_index(
    ...
    let result = store.install_from_directory(&content::InstallRequest {
        ...
        expected_sha256: Some(artifact_sha256),
...
mod tests {
    ...
    use super::{
        ...
        create_game_instance, execute_content_operation, execute_creator_command,
        execute_keymap_command, execute_permissions_command, execute_publisher_keys_command,
        execute_registry_command, load_marketplace_catalog, parse_launch_mode,
        remap_key_event_with_profiles, should_forward_key_to_runner, should_render_frame,
    };
